...
document.querySelector('#editAccount').addEventListener('click', function(){
...
const commentPostSubmit = function(e){
  e.preventDefault();
...
const removeMyPost = function(btn){
...
const commentPost = function(btn){
  let main_post_el = btn.closest('.single-post');
  let post_id = main_post_el.getAttribute('data-post_id');
